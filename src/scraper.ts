...
export async function getBankData(
  ...
  if (bank == "habenleumi") {
    ...
    await page.waitForSelector(
      "#layoutContainers > div > div.wptheme1Col > div > div.component-control.id-Z7_5G3DTJOFILEIE0QGETKUFF2G03 > section > div.wpthemeControlBody.wpthemeOverflowAuto.wpthemeClear.wellfixed > section > div:nth-child(3) > div > ul > li:nth-child(1) > a"
    );
    ...
    const button3 = await page.$(
      "#div3 > table > tbody > tr.tr_one > td.first > span > a"
    );
    await button3.click();
    await page.waitForNavigation({ waitUntil: "load" });
